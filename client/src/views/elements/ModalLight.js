        ...
        return (
            <div>
                    ...
                    <Modal isOpen={this.state.modal} toggle={this.toggle} >
                        <div className='modalWrapper' style={{ backgroundColor:'#5d5d5d' }}>
                            ...
                            <ModalBody style={{ textAlign: 'center'}}>
                                This badge automatically links to your profile page. Place it in your website footer or anywhere you want to display it on the page by copy/pasting the code snippet below. Alternatively, send the code to your developer. This is something they can also easily do for you.
                            </ModalBody>
